...
localFaqs:
  ...
  - q: "Do you install or replace fixtures?"
    a: "Yes—we install and replace fixtures like faucets, shower heads, and light fixtures where the connections already exist. Swapping an old faucet for a new one, upgrading a shower head, or putting in a new fixture is exactly the kind of handyman work we do. For actual pipe work, drains, or repairs inside the wall, we'll point you to a company that does that specific work—iFIXX is insured for the handyman work we do."
  - q: "Do you install ceiling fans and light fixtures?"
    a: "Yes, we install ceiling fans and light fixtures where a junction box already exists. This includes assembly, mounting, wiring to the existing circuit, and programming remotes. We don't run new circuits—that would be a larger project."
  - q: "How quickly can you come to Ballantyne?"
    a: "We often have same-day or next-day availability in Ballantyne. For non-urgent repairs, we typically schedule within 2-3 days. Call or text for current availability."
  - q: "What if something turns out to be a bigger issue?"
    a: "If a 'quick fix' reveals a larger problem—like a door that needs reframing rather than adjustment—we'll explain what's actually needed and provide a quote. You decide whether to proceed. No surprises."
...
localInfo:
  ...
  hoaConsiderations: "Interior Quick Fix repairs don't require Ballantyne HOA approval. Minor exterior items like mailbox repair may have HOA specifications we can follow."

seo:
  title: "Quick-Fix Handyman Ballantyne NC | Same-Day Small Repairs | iFIXX"
  description: "Same-day handyman — small repairs, no minimum, fast response in Ballantyne, NC. ⭐5.0 (87★) reviews. Same-day available. Free estimate ☎ (980) 391-6833."
---
...
**We Handle Everything**: Our handyman arrives with tools and common parts, works through your list, and leaves your home in better shape than he found it.
...
|--------|------|----------|
| Hourly | $75 - $95/hour | Lists with 3+ items |
...
- ✓ Replace garage weather stripping
- ✓ Install smoke detectors (2)
- ✓ Replace outlet covers (5)

**Time: 3 hours | Result: Move-in ready home**

## Why Ballantyne Families Use Quick Fix
...
Other contractors won't call back for small repairs. We specialize in them. That's the whole point.

### Trusted Handymen

We've served Ballantyne families for years. Our handymen are background-checked, experienced, and treat your home with respect.

### Honest Assessment

If something is a bigger issue than a quick fix, we'll tell you. We'll explain what's actually needed and quote the larger repair. No upselling, no invented problems.
