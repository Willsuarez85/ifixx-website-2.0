  ...
  integrations: [
    sitemap({
      ...
      filter: (page) => {
        ...
        // rule is now a guard rather than an exclusion — it keeps them out of the sitemap
        // if the route is ever reintroduced. The /service-areas hubs and the dedicated
        // money pages (single-segment URLs) are NOT affected.
